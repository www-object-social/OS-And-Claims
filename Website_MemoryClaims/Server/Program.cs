...
builder.Services.AddScoped(x => new Product.Infomation { Name = StandardInternal.product.infomation.Name.MemoryClaims, Software = Product.infomation.Software.Server });
