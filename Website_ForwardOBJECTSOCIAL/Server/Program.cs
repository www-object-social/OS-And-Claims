...
builder.Services.AddScoped(x => new Product.Infomation { Name = StandardInternal.product.infomation.Name.ForwardOBJECTSOCIAL, Software = Product.infomation.Software.Server });
